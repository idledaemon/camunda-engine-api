...
// checks if the FetchExternalTasksDtoSortingInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FetchExternalTasksDtoSortingInner{}

// FetchExternalTasksDtoSortingInner struct for FetchExternalTasksDtoSortingInner
type FetchExternalTasksDtoSortingInner struct {
...
func NewFetchExternalTasksDtoSortingInner() *FetchExternalTasksDtoSortingInner {
	this := FetchExternalTasksDtoSortingInner{}
	return &this
}
...
func (o *FetchExternalTasksDtoSortingInner) SetSortByNil() {
	o.SortBy.Set(nil)
}
...
func (o *FetchExternalTasksDtoSortingInner) SetSortOrderNil() {
	o.SortOrder.Set(nil)
}
...
func (o FetchExternalTasksDtoSortingInner) MarshalJSON() ([]byte, error) {
...
func (o FetchExternalTasksDtoSortingInner) ToMap() (map[string]interface{}, error) {
...
type NullableFetchExternalTasksDtoSortingInner struct {
	value *FetchExternalTasksDtoSortingInner
	isSet bool
}

func (v NullableFetchExternalTasksDtoSortingInner) Get() *FetchExternalTasksDtoSortingInner {
	return v.value
}

func (v *NullableFetchExternalTasksDtoSortingInner) Set(val *FetchExternalTasksDtoSortingInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFetchExternalTasksDtoSortingInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFetchExternalTasksDtoSortingInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFetchExternalTasksDtoSortingInner(val *FetchExternalTasksDtoSortingInner) *NullableFetchExternalTasksDtoSortingInner {
	return &NullableFetchExternalTasksDtoSortingInner{value: val, isSet: true}
}

func (v NullableFetchExternalTasksDtoSortingInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFetchExternalTasksDtoSortingInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
