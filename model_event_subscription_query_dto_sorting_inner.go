...
// checks if the EventSubscriptionQueryDtoSortingInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EventSubscriptionQueryDtoSortingInner{}

// EventSubscriptionQueryDtoSortingInner struct for EventSubscriptionQueryDtoSortingInner
type EventSubscriptionQueryDtoSortingInner struct {
...
func NewEventSubscriptionQueryDtoSortingInner() *EventSubscriptionQueryDtoSortingInner {
	this := EventSubscriptionQueryDtoSortingInner{}
	return &this
}
...
func (o *EventSubscriptionQueryDtoSortingInner) SetSortByNil() {
	o.SortBy.Set(nil)
}
...
func (o *EventSubscriptionQueryDtoSortingInner) SetSortOrderNil() {
	o.SortOrder.Set(nil)
}
...
func (o EventSubscriptionQueryDtoSortingInner) MarshalJSON() ([]byte, error) {
...
func (o EventSubscriptionQueryDtoSortingInner) ToMap() (map[string]interface{}, error) {
...
type NullableEventSubscriptionQueryDtoSortingInner struct {
	value *EventSubscriptionQueryDtoSortingInner
	isSet bool
}

func (v NullableEventSubscriptionQueryDtoSortingInner) Get() *EventSubscriptionQueryDtoSortingInner {
	return v.value
}

func (v *NullableEventSubscriptionQueryDtoSortingInner) Set(val *EventSubscriptionQueryDtoSortingInner) {
	v.value = val
	v.isSet = true
}

func (v NullableEventSubscriptionQueryDtoSortingInner) IsSet() bool {
	return v.isSet
}

func (v *NullableEventSubscriptionQueryDtoSortingInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventSubscriptionQueryDtoSortingInner(val *EventSubscriptionQueryDtoSortingInner) *NullableEventSubscriptionQueryDtoSortingInner {
	return &NullableEventSubscriptionQueryDtoSortingInner{value: val, isSet: true}
}

func (v NullableEventSubscriptionQueryDtoSortingInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventSubscriptionQueryDtoSortingInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
