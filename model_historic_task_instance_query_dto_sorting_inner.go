...
// checks if the HistoricTaskInstanceQueryDtoSortingInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HistoricTaskInstanceQueryDtoSortingInner{}

// HistoricTaskInstanceQueryDtoSortingInner struct for HistoricTaskInstanceQueryDtoSortingInner
type HistoricTaskInstanceQueryDtoSortingInner struct {
...
func NewHistoricTaskInstanceQueryDtoSortingInner() *HistoricTaskInstanceQueryDtoSortingInner {
	this := HistoricTaskInstanceQueryDtoSortingInner{}
	return &this
}
...
func (o *HistoricTaskInstanceQueryDtoSortingInner) SetSortByNil() {
	o.SortBy.Set(nil)
}
...
func (o *HistoricTaskInstanceQueryDtoSortingInner) SetSortOrderNil() {
	o.SortOrder.Set(nil)
}
...
func (o HistoricTaskInstanceQueryDtoSortingInner) MarshalJSON() ([]byte, error) {
...
func (o HistoricTaskInstanceQueryDtoSortingInner) ToMap() (map[string]interface{}, error) {
...
type NullableHistoricTaskInstanceQueryDtoSortingInner struct {
	value *HistoricTaskInstanceQueryDtoSortingInner
	isSet bool
}

func (v NullableHistoricTaskInstanceQueryDtoSortingInner) Get() *HistoricTaskInstanceQueryDtoSortingInner {
	return v.value
}

func (v *NullableHistoricTaskInstanceQueryDtoSortingInner) Set(val *HistoricTaskInstanceQueryDtoSortingInner) {
	v.value = val
	v.isSet = true
}

func (v NullableHistoricTaskInstanceQueryDtoSortingInner) IsSet() bool {
	return v.isSet
}

func (v *NullableHistoricTaskInstanceQueryDtoSortingInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHistoricTaskInstanceQueryDtoSortingInner(val *HistoricTaskInstanceQueryDtoSortingInner) *NullableHistoricTaskInstanceQueryDtoSortingInner {
	return &NullableHistoricTaskInstanceQueryDtoSortingInner{value: val, isSet: true}
}

func (v NullableHistoricTaskInstanceQueryDtoSortingInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHistoricTaskInstanceQueryDtoSortingInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
