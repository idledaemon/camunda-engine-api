...
// checks if the HistoricVariableInstanceQueryDtoSortingInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HistoricVariableInstanceQueryDtoSortingInner{}

// HistoricVariableInstanceQueryDtoSortingInner struct for HistoricVariableInstanceQueryDtoSortingInner
type HistoricVariableInstanceQueryDtoSortingInner struct {
...
func NewHistoricVariableInstanceQueryDtoSortingInner() *HistoricVariableInstanceQueryDtoSortingInner {
	this := HistoricVariableInstanceQueryDtoSortingInner{}
	return &this
}
...
func (o *HistoricVariableInstanceQueryDtoSortingInner) SetSortByNil() {
	o.SortBy.Set(nil)
}
...
func (o *HistoricVariableInstanceQueryDtoSortingInner) SetSortOrderNil() {
	o.SortOrder.Set(nil)
}
...
func (o HistoricVariableInstanceQueryDtoSortingInner) MarshalJSON() ([]byte, error) {
...
func (o HistoricVariableInstanceQueryDtoSortingInner) ToMap() (map[string]interface{}, error) {
...
type NullableHistoricVariableInstanceQueryDtoSortingInner struct {
	value *HistoricVariableInstanceQueryDtoSortingInner
	isSet bool
}

func (v NullableHistoricVariableInstanceQueryDtoSortingInner) Get() *HistoricVariableInstanceQueryDtoSortingInner {
	return v.value
}

func (v *NullableHistoricVariableInstanceQueryDtoSortingInner) Set(val *HistoricVariableInstanceQueryDtoSortingInner) {
	v.value = val
	v.isSet = true
}

func (v NullableHistoricVariableInstanceQueryDtoSortingInner) IsSet() bool {
	return v.isSet
}

func (v *NullableHistoricVariableInstanceQueryDtoSortingInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHistoricVariableInstanceQueryDtoSortingInner(val *HistoricVariableInstanceQueryDtoSortingInner) *NullableHistoricVariableInstanceQueryDtoSortingInner {
	return &NullableHistoricVariableInstanceQueryDtoSortingInner{value: val, isSet: true}
}

func (v NullableHistoricVariableInstanceQueryDtoSortingInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHistoricVariableInstanceQueryDtoSortingInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
