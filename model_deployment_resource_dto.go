...
// checks if the DeploymentResourceDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploymentResourceDto{}
...
func (o DeploymentResourceDto) ToMap() (map[string]interface{}, error) {
...
type NullableDeploymentResourceDto struct {
	value *DeploymentResourceDto
	isSet bool
}

func (v NullableDeploymentResourceDto) Get() *DeploymentResourceDto {
	return v.value
}

func (v *NullableDeploymentResourceDto) Set(val *DeploymentResourceDto) {
	v.value = val
	v.isSet = true
}

func (v NullableDeploymentResourceDto) IsSet() bool {
	return v.isSet
}

func (v *NullableDeploymentResourceDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeploymentResourceDto(val *DeploymentResourceDto) *NullableDeploymentResourceDto {
	return &NullableDeploymentResourceDto{value: val, isSet: true}
}

func (v NullableDeploymentResourceDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeploymentResourceDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
