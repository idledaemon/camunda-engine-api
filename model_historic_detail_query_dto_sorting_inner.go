...
// checks if the HistoricDetailQueryDtoSortingInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HistoricDetailQueryDtoSortingInner{}

// HistoricDetailQueryDtoSortingInner struct for HistoricDetailQueryDtoSortingInner
type HistoricDetailQueryDtoSortingInner struct {
...
func NewHistoricDetailQueryDtoSortingInner() *HistoricDetailQueryDtoSortingInner {
	this := HistoricDetailQueryDtoSortingInner{}
	return &this
}
...
func (o *HistoricDetailQueryDtoSortingInner) SetSortByNil() {
	o.SortBy.Set(nil)
}
...
func (o *HistoricDetailQueryDtoSortingInner) SetSortOrderNil() {
	o.SortOrder.Set(nil)
}
...
func (o HistoricDetailQueryDtoSortingInner) MarshalJSON() ([]byte, error) {
...
func (o HistoricDetailQueryDtoSortingInner) ToMap() (map[string]interface{}, error) {
...
type NullableHistoricDetailQueryDtoSortingInner struct {
	value *HistoricDetailQueryDtoSortingInner
	isSet bool
}

func (v NullableHistoricDetailQueryDtoSortingInner) Get() *HistoricDetailQueryDtoSortingInner {
	return v.value
}

func (v *NullableHistoricDetailQueryDtoSortingInner) Set(val *HistoricDetailQueryDtoSortingInner) {
	v.value = val
	v.isSet = true
}

func (v NullableHistoricDetailQueryDtoSortingInner) IsSet() bool {
	return v.isSet
}

func (v *NullableHistoricDetailQueryDtoSortingInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHistoricDetailQueryDtoSortingInner(val *HistoricDetailQueryDtoSortingInner) *NullableHistoricDetailQueryDtoSortingInner {
	return &NullableHistoricDetailQueryDtoSortingInner{value: val, isSet: true}
}

func (v NullableHistoricDetailQueryDtoSortingInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHistoricDetailQueryDtoSortingInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
