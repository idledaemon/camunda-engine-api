...
// checks if the GroupQueryDtoSortingInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupQueryDtoSortingInner{}

// GroupQueryDtoSortingInner struct for GroupQueryDtoSortingInner
type GroupQueryDtoSortingInner struct {
...
func NewGroupQueryDtoSortingInner() *GroupQueryDtoSortingInner {
	this := GroupQueryDtoSortingInner{}
	return &this
}
...
func (o *GroupQueryDtoSortingInner) SetSortByNil() {
	o.SortBy.Set(nil)
}
...
func (o *GroupQueryDtoSortingInner) SetSortOrderNil() {
	o.SortOrder.Set(nil)
}
...
func (o GroupQueryDtoSortingInner) MarshalJSON() ([]byte, error) {
...
func (o GroupQueryDtoSortingInner) ToMap() (map[string]interface{}, error) {
...
type NullableGroupQueryDtoSortingInner struct {
	value *GroupQueryDtoSortingInner
	isSet bool
}

func (v NullableGroupQueryDtoSortingInner) Get() *GroupQueryDtoSortingInner {
	return v.value
}

func (v *NullableGroupQueryDtoSortingInner) Set(val *GroupQueryDtoSortingInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupQueryDtoSortingInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupQueryDtoSortingInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupQueryDtoSortingInner(val *GroupQueryDtoSortingInner) *NullableGroupQueryDtoSortingInner {
	return &NullableGroupQueryDtoSortingInner{value: val, isSet: true}
}

func (v NullableGroupQueryDtoSortingInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupQueryDtoSortingInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
